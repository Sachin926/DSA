...
class traversal
{
	...
	public static void allInOne(Node head)
	{
		if (head == null)
			return;
		System.out.println(head.data + " Pre Order");
		allInOne(head.left);
		System.out.println(head.data + " In Order");
		allInOne(head.right);
		System.out.println(head.data + " Post Order");
	}
